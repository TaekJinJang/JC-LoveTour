                    ...
                    <Col md={3} className="d-grid gap-2 ms" style={{ height: '100%' }}>
                        ...
                        <ButtonGroup vertical>
                            ...
                            <Button
                                ...
                                variant={currentPage === '힐링 코스' ? 'success' : 'outline-success'} // 현재 페이지에 따라 스타일 설정
                                className="mb-2 p-2 rounded-0"
                                size="lg"
                                block
                                onClick={() => setCurrentPage('힐링 코스')} // 버튼 클릭 시 현재 페이지 업데이트
                            >
                                힐링 코스
                            </Button>
                            ...
                            <div className="card">
                                ...
                                >
                                    ...
                                    <p className="card-text">
                                        청풍지역은 자연경관이 수려하고 문물이 번성 했던 곳으로 많은 문화유적이 있었으나
                                        충주 댐 건설로 수몰될 위기에 놓였다. <br />
                                        1983년부터 3년간 수몰지역의 문화재를 원형대로 현재 위치에 이전 복원해 단지를
                                        조성했다.
                                    </p>
                                    <div
                                        className="card"
                                    ...
                                    >
                                        <p>
                                            ...
                                            주소: 제천시 청풍면 청풍호로 2048 &nbsp;&nbsp; 전화번호: 043)641-5532~5
                                        </p>
                                    </div>
                                </div>
                                {/* 화살표------------------------------------------------ */}
                                ...
                                >
                                    <div className="card text-center" style={{ width: '300px' }}>
                                        <div className="card-body d-flex justify-content-between align-items-center">
                                            <h5 className="card-title" style={{ marginBottom: '0', width: '50%' }}>
                                                점심시간
                                            </h5>
                                            <img
                                                src={lunch1}
                                ...
                                >
                                    ...
                                    <p className="card-text">
                                        제천을 대표하는 한방 약초원과 풍부한 수계 자원을 활용한 산림치유 프로그램을
                                        채험할 수 있다. 금수산을 배경으로 건강, 음이온, 숲내음, 자작나무 등 4코스의
                                        치유숲길과 명산치유, 오감힐링, 웃음치유등 테라피 프로그램을 체험할 수 있다.
                                    </p>
                                    <div
                                        className="card"
                                        style={{
                                    ...
                                    >
                                        <p>
                                            <i className="bi bi-house" style={{ fontSize: '1.5rem' }}></i>
                                            주소: 제천시 청풍면 학현소야로 590 &nbsp;&nbsp; 전화번호: 043)653-9869
                                        </p>
                                    </div>
                                </div>
                                {/* 화살표------------------------------------------------ */}
                                ...
                                >
                                    ...
                                    <p className="card-text">
                                        청전동과 의림지 사이에 위치한 자연 생태체험공간 으로 2km에 달하는 1자형 걷기길에
                                        수목류, 초화류 등 140여종의 식물을 식재하여 시민들의 많은 사랑을 받고 있는
                                        산책로이다.
                                    </p>
                                    <div
                                        className="card"
