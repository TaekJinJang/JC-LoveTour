    ...
    return (
        <>
            <Card
                ...
                style={{ borderColor: '#37ba86', backgroundColor: '#37ba86', textAlign: 'center' }}
            >
            ...
            <ButtonGroup vertical className="w-100 mt-2 p-0">
                {buttons.map((button, index) => (
                    <Button
                        href={button.href}
                        key={index}
                        variant={currentPage === button.label ? 'success' : 'outline-light'}
                        className="mb-2 rounded-0 px-0"
                        // block
                        onClick={() => setCurrentPage(button.label)}
                        style={{ borderColor: '#37ba86', backgroundColor: '#37ba86' }}
                    >
                        {button.label}
                    </Button>
                ))}
